...
class Usuario(Base):
    ...
    color_detalle: Mapped[str] = mapped_column(Text, default="#222222")
    forma_cuerpo: Mapped[str] = mapped_column(Text, default="normal")
    cara: Mapped[str] = mapped_column(Text, default="feliz")
    espalda: Mapped[str] = mapped_column(Text, default="ninguna")
